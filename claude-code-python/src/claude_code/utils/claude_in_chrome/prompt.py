"""Chrome automation system prompt constants. Ported from utils/claudeInChrome/prompt.ts"""
...
def get_chrome_system_prompt() -> str:
    """Return the base Chrome automation system prompt."""
