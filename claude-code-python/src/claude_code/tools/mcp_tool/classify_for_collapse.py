"""
Classify MCP tools as search/read for UI collapsing.
Ported from tools/MCPTool/classifyForCollapse.ts

Uses explicit per-tool allowlists for the most common MCP servers.
Tool names are normalized to snake_case before matching.
...
# fmt: off
SEARCH_TOOLS: frozenset = frozenset([
    # Slack
    ...
    "search_monitors", "search_monitor_groups", "find_slow_spans",
    "find_monitors_matching_pattern",
    # Sentry
    "search_docs", "search_events", "search_issue_events", "find_organizations",
    "find_teams", "find_projects", "find_releases", "find_dsns",
    # Notion
    "search",
    # Gmail
    ...
    # Atlassian/Jira (camelCase → normalized)
    ...
    "search_records",
    # Todoist
    "find_tasks", "find_tasks_by_date", "find_completed_tasks", "find_projects",
    "find_sections", "find_comments", "find_project_collaborators",
    "find_activity", "find_labels", "find_filters",
    # AWS
...
READ_TOOLS: frozenset = frozenset([
    ...
    "slack_read_user_profile", "slack_list_channels", "slack_get_channel_history",
    ...
    "get_discussion", "get_discussion_comments", "list_discussion_categories",
    "list_discussions", "list_starred_repositories", "get_issue", "get_pull_request",
    ...
    "list_issue_statuses", "get_issue_status", "list_my_issues", "list_issue_labels",
    "list_projects", "get_project", "list_project_labels", "list_teams", "get_team",
    "list_users", "get_user",
    # Datadog
    "aggregate_logs", "list_spans", "aggregate_spans", "analyze_trace",
    "trace_critical_path", "query_metrics", "aggregate_rum_events", "list_rum_metrics",
    "get_rum_metric", "list_monitors", "get_monitor", "check_can_delete_monitor",
    "validate_monitor", "validate_existing_monitor", "list_dashboards", "get_dashboard",
    "query_dashboard_widget", "list_notebooks", "get_notebook", "query_notebook_cell",
    ...
    "list_issue_events", "get_sentry_issue",
    # Notion
    ...
    "confluence_get_labels", "jira_get_issue", "jira_get_transitions",
    "jira_get_worklog", "jira_get_agile_boards", "jira_get_board_issues",
    "jira_get_sprints_from_board", "jira_get_sprint_issues", "jira_get_link_types",
    "jira_download_attachments", "jira_batch_get_changelogs", "jira_get_user_profile",
    "jira_get_project_issues", "jira_get_project_versions",
    # Asana
    "asana_get_attachment", "asana_get_attachments_for_object", "asana_get_goal",
    "asana_get_goals", "asana_get_parent_goals_for_goal", "asana_get_portfolio",
    "asana_get_portfolios", "asana_get_items_for_portfolio", "asana_get_project",
    "asana_get_projects", "asana_get_project_sections", "asana_get_project_status",
    "asana_get_project_statuses", "asana_get_project_task_counts",
    "asana_get_projects_for_team", "asana_get_projects_for_workspace", "asana_get_task",
    "asana_get_tasks", "asana_get_stories_for_task", "asana_get_teams_for_workspace",
    "asana_get_teams_for_user", "asana_get_team_users", "asana_get_time_period",
    ...
    # PagerDuty
    "get_incident", "get_outlier_incident", "get_past_incidents",
    "get_related_incidents", "list_incident_notes", "list_incident_workflows",
    ...
    "get_escalation_policy", "list_event_orchestrations", "get_event_orchestration",
    "list_status_pages", "get_status_page_post", "list_alerts_from_incident",
    "get_alert_from_incident", "list_change_events", "get_change_event",
    # Supabase
    "list_organizations", "get_organization", "get_cost", "list_extensions",
    "list_migrations", "get_logs", "get_advisors", "get_project_url",
    "get_publishable_keys", "generate_typescript_types", "list_edge_functions",
    "get_edge_function", "list_storage_buckets", "get_storage_config",
    # Stripe
    "get_stripe_account_info", "retrieve_balance", "list_customers", "list_products",
    "list_prices", "list_invoices", "list_payment_intents", "list_subscriptions",
    ...
    "get_paper_fulltext", "get_pubmed_article_metadata", "download_pubmed_pdf",
    "pubmed_fetch", "pubmed_pmc_fetch", "pubmed_spell", "pubmed_cite", "pubmed_related",
    # BigQuery
    "bigquery_query", "bigquery_schema", "list_dataset_ids", "list_table_ids",
    ...
    # MongoDB
    "list_databases", "list_collections", "collection_indexes", "collection_schema",
    "collection_storage_size", "db_stats", "explain", "mongodb_logs", "aggregate",
    "count", "export",
    # Neo4j
    "get_neo4j_schema", "read_neo4j_cypher", "list_instances", "get_instance_details",
    ...
    # Todoist
    "get_productivity_stats", "get_overview", "fetch_object", "user_info",
    "list_workspaces", "view_attachment",
    # AWS
    "get_available_services", "read_documentation", "read_sections", "recommend",
    "analyze_log_group", "analyze_metric", "describe_log_groups", "get_active_alarms",
    "get_alarm_history", "get_metric_data", "get_metric_metadata",
    # Kubernetes
    "kubectl_get", "kubectl_describe", "kubectl_logs", "kubectl_context",
    "explain_resource", "list_api_resources", "namespaces_list", "nodes_log",
    "nodes_top", "pods_get", "pods_list", "pods_list_in_namespace", "pods_log",
    "pods_top", "resources_get", "resources_list",
])
# fmt: on


def _normalize(name: str) -> str:
    """Normalize camelCase/kebab-case to snake_case."""
...
def classify_mcp_tool_for_collapse(
    ...
    Returns ``{"isSearch": bool, "isRead": bool}``.
    ``_server_name`` is accepted for API compatibility but not used — matching
    is keyed on the tool name alone.
    """
