"""Preapproved hosts for WebFetchTool. Ported from WebFetchTool/preapproved.ts"""
...
# Split into hostname-only and path-prefix sets for efficient lookups
_HOSTNAME_ONLY: frozenset[str] = frozenset(
    e for e in PREAPPROVED_HOSTS if "/" not in e
)
...
def is_preapproved_host(hostname: str, pathname: str) -> bool:
    """Return True if the given hostname+pathname is in the preapproved list."""
