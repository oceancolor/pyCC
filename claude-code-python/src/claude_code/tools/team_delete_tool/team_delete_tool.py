"""TeamDeleteTool (standalone copy). Ported from TeamDeleteTool/TeamDeleteTool.ts"""
...
- All teammates have finished their work
- You want to clean up the team's resources
"""
