"""General purpose agent definition. Ported from AgentTool/built-in/generalPurposeAgent.ts"""
...
def get_general_purpose_system_prompt() -> str:
    return (
        f"{SHARED_PREFIX} When you complete the task, respond with a concise report covering "
...
GENERAL_PURPOSE_AGENT = {
    ...
    "source": "built-in",
    "baseDir": "built-in",
    "getSystemPrompt": get_general_purpose_system_prompt,
}
