"""Explore agent definition. Ported from AgentTool/built-in/exploreAgent.ts"""
...
EXPLORE_WHEN_TO_USE = (
    ...
    "by patterns (eg. \"src/components/**/*.tsx\"), search code for keywords "
...
def get_explore_system_prompt() -> str:
    glob_guidance = "- Use Glob for broad file pattern matching"
    grep_guidance = "- Use Grep for searching file contents with regex"
...
EXPLORE_AGENT = {
    ...
    "model": "haiku",
    "omitClaudeMd": True,
    "getSystemPrompt": get_explore_system_prompt,
}
